...
function recuperar_pais() {


    b_pais.innerHTML = `${pais_usuario}`;
}
...
/* paises */
var vetor_nacionalidade = ['Brasil', 'Brasil', 'Brasil ', 'Colômbia', 'Brasil', 'Brasil', 'Brasil', 'Brasil', 'Brasil',
...
function verificar_autenticacao() {
    ...
    if (login_usuario == undefined) {
        /*  img3.setAttribute('src', `Imagens/Bandeiras/${pais_usuario}.png`); */
    } else {
